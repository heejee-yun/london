 ...
 * 
 * 
 * @RequestMapping(value="userView") public String userView(UserVo vo, Model
 * model) throws Exception{ User result = service.selectOne(vo);
 * model.addAttribute("item", result); return "infra/uer/xdmin/memeberForm"; }
 * 
 * 
 * 
 * 
